...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        ...
        <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-sm border-t-4 border-indigo-500">
            ...
            <a href="/videos" class="block w-full text-center mt-6 py-2 px-4 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition duration-150 shadow-md">
                Lihat Penugasan
            </a>
